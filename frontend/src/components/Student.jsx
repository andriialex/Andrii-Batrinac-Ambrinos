                              ...
                              <div className="bg-white px-4 py-5 sm:p-6">
                                    <div className="grid grid-cols-6 gap-6">
                                          ...
                                          <div className="col-span-6 sm:col-span-3">
                                                <input type="text" name="cod" id="cod" className="mt-1 block w-full rounded-md border-gray-500 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm h-12 pl-10" required placeholder='Cod curs' />
                                          </div>
                              ...
                              <tbody>
                                    {data?.length > 0 ? data.map((item) => (
                                          <tr className="bg-white border-b dark:bg-gray-900 dark:border-gray-700" key={item.id}>
                                                ...
                                                <td className="py-4 px-6">
                                                      <a href={`/react/${item.id}`} className="font-medium text-blue-600 dark:text-blue-500 hover:underline">Reactioneaza</a>
                                                </td>
                                          </tr>
                                    )) : <>
